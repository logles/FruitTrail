...
function Header() {
  return (
    <header
      id="header"
      className="grid h-[175px] place-content-center place-items-center overflow-hidden bg-gradient-to-b from-green-900 to-amber-700"
    >
      <div
        id="main_container"
      ...
      >
        <div className="flex justify-center items-center size-40 m-5">
          <TreeLogo />
          <h1 id="h1" className="title text-6xl font-black text-green-500">
            FruitTrail
          </h1>
        </div>
